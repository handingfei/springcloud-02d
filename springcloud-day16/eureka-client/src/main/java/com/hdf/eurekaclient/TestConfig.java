...
public class TestConfig {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\study\\BigDataSenior5SpringCloud\\code\\springcloud-day16\\eureka-client\\src\\main\\java");
        ...
        strategy.setInclude("t_user_day16");
        mpg.setStrategy(strategy);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.hdf.eurekaclient");
