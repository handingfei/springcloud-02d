...
public class TestConfig {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\study\\BigDataSenior5SpringCloud\\code\\zhoukao2handingfeispringcloud\\user-client\\src\\main\\java");
        ...
        strategy.setInclude("week2user");

        mpg.setStrategy(strategy);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.hdf.userclient");
